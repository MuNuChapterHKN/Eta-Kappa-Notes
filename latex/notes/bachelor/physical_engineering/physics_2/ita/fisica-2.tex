...
\NewDocumentCommand{\addfigure}{O{} O{0.6} m}{
    \begin{figure}[H]  % !h or H
        \centering
        \includegraphics[width=#2\textwidth]{res/#3}
        \caption{#1}
        \label{fig:#3}
    \end{figure}
}
\NewDocumentCommand{\addsvg}{O{} O{0.4} m}{
    \begin{figure}[H]  % !h or H
        \centering
        \includesvg[width=#2\textwidth]{res/svg/#3.svg}
        \caption{#1}
        \label{fig:#3}
    \end{figure}
}
\NewDocumentCommand{\adddrawio}{O{} O{0.4} m}{
    \begin{figure}[H]  % !h or H
        \centering
        \includesvg[width=#2\textwidth,inkscapelatex=true]{res/drawio/#3.drawio.svg}
        \caption{#1}
        \label{fig:#3}
    \end{figure}
}
