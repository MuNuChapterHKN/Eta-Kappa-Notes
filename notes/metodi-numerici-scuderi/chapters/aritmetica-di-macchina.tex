...
\[F=\{0\}\cup\{(-1)^{s}\,0\,.\,a_1\,a_2\,\dots\,a_t\cdot N^q,\quad 0\leq a_i<N,\quad a_1\ne0,\quad
L\leq q\leq U\}\]
Il più piccolo numero di macchina positivo (diverso dallo zero) appartenente a $F$ è
\[m=0.\underbrace{10\dots0}_{t\text{ cifre}}\,\cdot\,N^L\]
...
\begin{itemize}
    ...
    overflow, riformulando l'espressione che causa il fenomeno.
...
In un calcolatore non è possibile eseguire esattamente le operazioni aritmetiche, ma solo le
