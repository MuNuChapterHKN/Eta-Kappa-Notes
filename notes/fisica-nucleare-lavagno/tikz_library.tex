...
\usetikzlibrary{decorations.pathreplacing,decorations.markings,decorations.pathmorphing,arrows.meta}
\tikzset{
  >=stealth, % set the default arrow tip
  ...
  midarrow/.style={
    ...
    postaction={
      on each segment={
        ...
        decoration={
          markings,
          mark=at position 0.5 with {\arrow[xshift=1mm]{stealth}}
        }
      }
    }
  },
...
\makeatother
\newcommand{\addfeynman}[4][]{
    \begin{figure}[H]  % !h or H
        \centering
        \tikz[scale=#3,transform shape,every node/.style={text=black,font=\footnotesize}]{
            #2
        }
        \caption{#1}
        \label{feynm:#4}
