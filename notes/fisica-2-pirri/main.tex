...
\newcommand{\book}{\textit{Copyright 1969 Addison-Wesley, da M.\ Alonso ed E.\ Finn, ``Elementi di Fisica per l'università, Volume 2''.}}
\newcommand{\addfigurebook}[3][]{
    \ifx\relax#1\relax
        \addfigure[\book]{book/#2}{#3}
    \else
        \addfigure[#1 \\ \book]{book/#2}{#3}
    \fi
}
...
\courseinfo{
    code = 19AXPOD,
    name = {Fisica II},
    teacher = {Prof.\ Candido Fabrizio Pirri},
    program_level = bachelor,
    program = {Ingegneria Fisica},
    program_en = {Physical Engineering},
