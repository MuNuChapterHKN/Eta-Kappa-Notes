...
\addfigurebook{waves_proof_2}{0.6}
...
\addfigurebook{waves_proof_1}{0.6}
...
\addfigurebook[Onda elettromagnetica polarizzata circolarmente.]{polarizzazione_circolare}{0.6}
...
\addfigurebook[Onde piane, cilindriche e sferiche che si propagano in un mezzo isotropo.]{onde_isotropo}{0.6}
...
\addfigurebook{pressione_di_radiazione}{0.6}
