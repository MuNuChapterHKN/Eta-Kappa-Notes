...
\[
\mathcal S_{\mathbb{R}}=\{x:I\to\mathbb{R}\ \text{di classe }C^2 \mid L[x]=0\}
\]
è uno spazio vettoriale su \(\mathbb{R}\). Inoltre, per teoria standard delle ODE, \(\dim_{\mathbb{R}}(\mathcal S_{\mathbb{R}})=2\):
