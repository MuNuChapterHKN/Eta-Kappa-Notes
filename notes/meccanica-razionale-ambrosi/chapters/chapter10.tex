...
\begin{definition}{}
Sia $\underline{q}(t)$ una soluzione delle equazioni del moto di un sistema
meccanico e sia $\hat{\underline{q}}$ una configurazione di equilibrio.

La configurazione di equilibrio $\hat{\underline{q}}$ si dice stabile se
\[
\forall \varepsilon>0\ \exists \delta>0
\]
tale che, per ogni soluzione $\underline{q}(t)$,
\[
