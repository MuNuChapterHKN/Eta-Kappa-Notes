...
\begin{tikzpicture}[scale=1.05, line cap=round, line join=round]
  ...
  % archetto di rotazione nel piano xy
  \draw[line width=1.0pt] (1.2,0) arc[start angle=0,end angle=45,radius=1.2];
  \draw[->,line width=1.0pt] ({1.2*cos(45)},{1.2*sin(45)}) -- ++(0.001,0.001);
