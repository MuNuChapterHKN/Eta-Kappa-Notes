...
% vettore differenza
\draw[->,green] (X2) -- (X1) node[midway, above right] {$\underline{x_i^{'}}$}; % differenza tra i vettori
...
\[
\sum_{i=1}^{n} m_i \ddot{\underline{x}}_i = \sum_{i=1}^{n} m_i \frac{d^2}{dt^2} \left( \underline{x}_G + \underline{x}^{'}_i \right) = \frac{d^2}{dt^2} \left( \sum_{i=1}^{n} m_i \underline{x}_G + \sum_{i=1}^{n} m_i \underline{x}^{'}_i \right)
\]
...
\]
\[
,b_3[a_1c_1+a_2c_2+a_3b_3]-c_3[a_1b_1+a_2b_2+a_3b_3]
\bigr)=
\]
...
\underline{M}
=
(\underline{x}_1-\underline{x}_p)\wedge f\,\hat m
+
(\underline{x}_2-\underline{x}_p)\wedge (-f\,\hat m)
=
(\underline{x}_1-\underline{x}_2)\wedge f\,\hat m
\]
...
\begin{tikzpicture}[scale=1.1]
    % assi
    \draw[->,line width=1.2pt] (0,0) -- (8.2,0) node[right] {$x$};
    ...
    \coordinate (S1) at (0,4.85);
    \coordinate (S2) at (0,4.15);
    ...
    \draw[line width=1.3pt] (-0.12,3.65) -- (-0.12,3.1);
    \draw[line width=1.3pt] ( 0.12,3.65) -- ( 0.12,3.1);

    % guida verticale in B
    \draw[line width=1.3pt] (4.7 , 0.12) -- (5.2 , 0.12);
    \draw[line width=1.3pt] (4.7 ,- 0.12) -- (5.2, -0.12);
    ...
    \draw[line width=1.2pt] (S1) -- (S2);
    \draw[line width=1.2pt]
        (S2) -- (-0.12,4.02) -- (0.12,3.89) -- (-0.12,3.76) -- (0.12,3.63) -- (-0.12,3.50) -- (0.12,3.37) -- (A);
    ...
    \node[red,right] at ($(A)+(0.02,0.55)$) {$\underline{F}_e$};

    \draw[->,red,line width=1.1pt] (G) -- ++(0,-0.95);
    \node[red,right] at ($(G)+(0.15,-0.45)$) {$m\underline{g}$};

    % reazioni vincolari
    \draw[->,green!60!black,line width=1.1pt] (A) -- ++(1.55,0);
    \node[green!60!black,above] at ($(A)+(1.2,0)$) {$\underline{\psi}$};

    \draw[->,green!60!black,line width=1.1pt] (B) -- ++(0,1.25);
    \node[green!60!black,right] at ($(B)+(0,0.75)$) {$\underline{\varphi}$};

    % angolo theta
    \draw[->,line width=0.9pt] (0,2.5) arc[start angle=-90,end angle=-35,radius=0.9];
    \node at (2.2,0.95) {$\theta$};

    % versore k uscente
    \node[red] at (3.45,5.0) {$\odot\,\hat{k}$};
\end{tikzpicture}
