...
\courseinfo{
    code = 01TUSOD,
    name = {Advanced methods for physics},
    teacher = {Prof.\ Dario Daghero},
...
\include{chapters/Introduction_to_special_relativity}
\include{chapters/Fundamentals_of_relativity}
\include{chapters/Tensors}
\include{chapters/Representation_of_spacetime}
\include{chapters/Classical_quantities_in_Special_Relativity}
\include{chapters/Relativistic_formulation_of_electromagnetism}
