...
% \RefsDefaultLinks       % AVVIO SOVRASCRITTURA IMPOSTAZIONI GLOBALI
%                         % NOTA: ho usato questo approccio per scrivere i colori una volta sola. Avevo creato macro
%                         % ausiliarie solo con le opzioni di interesse, ma dovevo comunque riscrivere i colori più volte.
% \hypersetup{%
...
\begin{comment}
COME PATCHARE NEL MODO GIUSTO? LE VARIE POSSIBILITÀ ANALIZZATE.
