...
\begin{comment}     % --- RIEPILOGO MACRO (COMANDI) MODIFICATE O SOVRASCRITTE NELLA CLASSE "HKNdocument" ---
    ...
    \emph               % Sovrascritto dal pacchetto ulem, che lo sostituisce con \uline, che sottolinea invece di mettere in corsivo.
                        % FIXATO: ha cauato un bug di Overfull nella bibliografia. Vedi file 00.0_EarlyInitializationDirectives.tex per spiegazioni.
    ...
    contatore padre. In precisione, in _preamble.tex caricato dalla custom class HKNdocument, sono esplicitamente riportati i seguenti comandi per farsi che
