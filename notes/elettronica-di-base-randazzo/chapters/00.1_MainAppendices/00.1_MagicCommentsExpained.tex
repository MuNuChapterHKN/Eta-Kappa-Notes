...
%
% NOTA: per chi ha studiato C, ricordano un po' le direttive al preprocessore (#define, #undef eccetera), in particoalre
...
% VS Code è un IDE moderno, tecnicamente potrebbero essere scritti in qualsiasi puntod del file, in qualsiasi quantità,
...
% Il percorso verso il file root deve seguire una sintassi rigida, e sono disponibili due modlità principali per
% specificarlo:
%
...
%   quanto funzionanerebbero su qualsiasi macchina, a patto che la struttura delle cartelle rimanga intatta,
...
%   la sintassi esplicita % !TEX root = ./main.tex e % !TEX root = ./<foldername>/main.tex ripsettivamente, dove
...
%   In particoalre inserire un "\" in un magic comment causerà un errore di parsing, poiché il motore lo interpreterà
...
%    auto-rilevamento.
%
% A rigurado la documentazione ufficiale di LaTeX Workshop riporta, a link:
