...
\cref{fig:wordVSlatex.png}.
\addfigure[Word vs \LaTeX{} {[}
\textit{%
fonte: %
\href{https://mappingignorance.org/2015/04/06/word-or-latex-typesetting-which-%
...
% BIBLIOGRAFIA LINK
% correzioni testo prefazione
% citazione wigner
% citazione calcolo infinitesimale
% parlare di esame ed esercizi tipici -> temi d'esame proposti.
