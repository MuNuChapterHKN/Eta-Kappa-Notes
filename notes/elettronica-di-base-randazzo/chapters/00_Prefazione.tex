...
\begin{itemize}
\item il libro di testo di \emph{Storey}
\autocite{storey4ed}\autocite{storey6ed} (quello principale)
\item il libro di testo di \emph{Floyd} \autocite{floyd}, e quello degli autori
\emph{Jaeger, Blalock e Blalock} \autocite{jaegerblalock} (quelli secondari)
\end{itemize}
