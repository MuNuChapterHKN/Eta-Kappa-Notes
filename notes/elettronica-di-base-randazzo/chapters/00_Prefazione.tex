...
troverà spazio per maggiori dettagli e approfondimenti utili.

Il contenuto del libro cerca inoltre di \textbf{rispecchiare fedelmente il
programma del corso}, tant'è che i suoi capitoli sono stati denominati e
suddivisi, seguendo lo stesso schema utilizzato dal materiale didattico, in
precisione dalle slide (o per i più nostalgici, \fig{dai lucidi}). Si confida
nel fatto che questo possa favorire una sinergia generale con il materiale
ufficiale, e quindi che possa aiutare lo studente a orientarsi e a trarne
beneficio.

% Contenuti VS approfondimenti
